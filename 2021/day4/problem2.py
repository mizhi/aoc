...
def find_last_winning_value(game_nums, all_boards):
  bingod_boards = []
  for game_num in game_nums:
    for board in all_boards:
      ...
      if board.has_bingo():
        bingod_boards.append((game_num, board))
  return bingod_boards[-1][0] * sum(bingod_boards[-1][1].unmarked_values())

game_nums, all_boards = parse_game_file()

print(find_last_winning_value(game_nums, all_boards))
